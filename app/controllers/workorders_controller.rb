...
class WorkordersController < ApplicationController
  ...
  def export_detail
    ...
    @q_data   = HttpTestScore.where(:test_time.gte => b_time, :test_time.lt => e_time, :negative_items_scores.lt => 0, :source_node_name => snn).order_by([:negative_items_scores,:asc]).paginate page: params[:page], per_page: 10
  end
